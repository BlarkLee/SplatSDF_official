...
from project.nerf.utils.misc import collate_test_data_batches, get_unique_test_data, trim_test_samples
...
class BaseTrainer(BaseTrainer):
    ...
    @torch.no_grad()
    def test(self, cfg, data_loader, single_gpu=False, profile=False, show_pbar=False):
        # Test.
        super().test(cfg, data_loader, single_gpu, profile, show_pbar)
