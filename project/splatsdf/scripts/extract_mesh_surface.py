...
from project.splatsdf.utils.mesh_surface import extract_mesh_surface, extract_texture 
...
def main():
    ...
    sdf_func = lambda x,f: -trainer.model_module.neural_sdf.sdf(x,f) 
    sdf_func_enc = lambda x,f: trainer.model_module.neural_sdf.encode(x,f) 
